...
public class LocalStack extends Stack {
    ...
    private final Cluster eskCluster;
    ...
    private FargateService createFargateService(String id, String imageName, List<Integer> ports, DatabaseInstance db, Map<String, String> additionalEnvVars) {
        ...
        ContainerDefinitionOptions.Builder containerOptions = ContainerDefinitionOptions
                ...
                .portMappings(ports.stream().map(p -> PortMapping.builder()
                                .containerPort(p)
        ...
        ContainerDefinitionOptions containerDefinitionOptions = containerOptions.environment(envVars).build();
